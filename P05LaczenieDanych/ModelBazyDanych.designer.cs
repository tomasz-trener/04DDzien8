...
namespace P05LaczenieDanych
{
    ...
    partial void DeleteZawodnik(Zawodnik instance);
		...
		public ModelBazyDanychDataContext() : 
				base(global::P05LaczenieDanych.Properties.Settings.Default.tomasz1_zawodnicyConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnwagaChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_id_zawodnika", DbType="Int NOT NULL", IsPrimaryKey=true)]
